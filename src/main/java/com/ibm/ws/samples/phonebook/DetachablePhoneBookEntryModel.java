...
public class DetachablePhoneBookEntryModel  implements IModel<PhoneBookEntry> {

	PhoneBookEntry object;
	
	public DetachablePhoneBookEntryModel(String name) {
        this.object = PhoneBookEntryDataProvider.phoneBookDataBase.get(name);
	}
	public DetachablePhoneBookEntryModel(PhoneBookEntry phoneBookEntry) {
        this.object = phoneBookEntry;
	}
	...
	@Override
	public PhoneBookEntry getObject() {
		return object;
	}

	@Override
	public void setObject(PhoneBookEntry object) {
		this.object = object;
	}
